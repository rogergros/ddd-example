...
final class NotFinishedGamesHandler implements QueryHandler
{
     ...
     */
    public function __invoke(NotFinishedGames $query): array
    {
        return $this->assembler->assembleMultiple($this->repository->notFinished());
    }
}
